<?php
    ...
    $header_title    = "Hotel Booking::Edit Room Special Features";
    $proc_error      = false;
    $error_message   = "";
    $table           = "special_features";
    ...
    if (isset($_GET["id"])) {
        ...
        if ($row <= 0) {
            $url                  = $cp_base_url . "show_room_special_features.php";
            header("Location:" . $url);
            exit();
        } else {  
        ...
        if ($proc_error == false) {
            ...
            $url                  = $cp_base_url . "show_room_special_features.php?message=update";
            header("Location:" . $url);
            exit();
        }
    } else {
        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form class="" action="<?= $cp_base_url ?>edit_room_special_features.php" method="post" novalidate>
                                <span class="section">Edit Room Special Features</span>
                                ...
                                <div class="ln_solid">
                                    <div class="form-group">                                  
                                        <div class="col-md-6 offset-md-3 mt-2">
                                            ...
                                            <a href="<?= $cp_base_url ?>show_room_special_features.php" class="btn btn-success">Cancel</a>
