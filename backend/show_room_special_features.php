<?php
    ...
    $header_title            = "Hotel Booking::Hotel Special Features Listing";
    $proc_error              = false;
    $error_message           = "";
    ...
    switch ($status_message) {
        case "success":
            $success         = true;
            $success_message = "Room Special Features Created Successfully!";
            break;
        case "update":
            $success         = true;
            $success_message = "Room Special Features Updated Successfully!";
    }
        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <h3>Show Room Special Features</h3>
                </div>
            </div>
                                        ...
                                        <?php
                                            if ($res_row >= 1) {
                                                while ($row = $res_show_sql->fetch_assoc()) { 
                                                    ...
                                                    $edit_url = $cp_base_url . "edit_room_special_features.php?id=" . $id;
                                        ?>
