<?php
    ...
    $header_title    = "Hotel Booking::Create Special Features";
    $proc_error      = false;
    $error_message   = "";
    ...
    if (isset($_POST["submit"]) && $_POST["form-submit"] == 1) {
        ...
        if ($proc_error == false) {
            ...
            $url                  = $cp_base_url . "show_room_special_features.php?message=success";
            header("Location:" . $url);
            exit();
        } 
    } 
        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form class="" action="<?= $cp_base_url ?>create_room_special_features.php" method="post" novalidate>
