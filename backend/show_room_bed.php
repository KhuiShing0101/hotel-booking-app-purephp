<?php
    ...
    $header_title            = "Hotel Booking::Hotel Bed Listing";
    $proc_error              = false;
    $error_message           = "";
    $table                   = "beds";
    $table_no                = 1;
    ...
    switch ($status_message) {
        case "success":
            $success         = true;
            $success_message = "Room Bed Created Successfully!";
            break;
        case "update":
            $success         = true;
            $success_message = "Room Bed Updated Successfully!";
    }
                                        ...
                                        <?php
                                            if ($res_row >= 1) {
                                                while ($row = $res_show_sql->fetch_assoc()) { 
                                                    ...
                                                    $edit_url = $cp_base_url . "edit_room_bed.php?id=" . $id; 
                                        ?>
