<?php
    ...
    if (isset($_GET["id"])) {
        ...
        if ($proc_error == false) {
            ...
            $url                  = $cp_base_url . "show_room_view.php?message=update";
            header("Location:" . $url);
            exit();
        }
    } else {
        ...
        <div class="">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        <div class="x_content">
                            <form class="" action="<?= $cp_base_url ?>edit_room_view.php" method="post" novalidate>
                                ...
                                <div class="ln_solid">
                                    <div class="form-group">                                  
                                        <div class="col-md-6 offset-md-3 mt-2">
                                            ...
                                            <a href="<?= $cp_base_url ?>show_room_view.php" class="btn btn-success">Cancel</a>
